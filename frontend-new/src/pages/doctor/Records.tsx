...
import { MOCK_DASHBOARD_DATA } from '../../data/mockData'; // Fixed to standard filename
...
export default function Records() {
  ...
  const filteredRecords = MOCK_DASHBOARD_DATA.filter(patient => 
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-muted-foreground font-mono">{patient.patient.id}</p>
                    </div>
                  </div>
