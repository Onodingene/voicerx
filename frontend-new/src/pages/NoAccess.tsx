...
const NotFound = () => {
  ...
  useEffect(() => {
    console.error("403 Error: User attempted to access a page not permitted to access", location.pathname);
  }, [location.pathname]);

  return (
    <div className="flex min-h-screen items-center justify-center bg-muted">
      <div className="text-center">
        <h2 className="mb-3 text-3xl font-bold text-slate-900 font-heading">Access Denied</h2>
            <p className="mx-auto mb-10 max-w-md text-slate-500 font-medium font-subheading">
              You are not permitted to view<span className="text-[#390C87] font-mono bg-purple-50 px-1 rounded">{location.pathname}</span> this page.
            </p>
